...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        # Filter data by selected site and calculate success vs failure
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
        filtered_df = filtered_df.groupby('class').size().reset_index(name='count')
        fig = px.pie(filtered_df, values='count', names='class', title=f"Success vs. Failure for site {entered_site}")
        return fig
